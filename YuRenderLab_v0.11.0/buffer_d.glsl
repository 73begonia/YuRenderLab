// ============================================================================
// YuRenderLab v0.11 - Buffer D (状态管理)
// 原始通道映射:
//   iChannel0: self (前帧数据)
//   iChannel1: Keyboard → 改为 #iKeyboard
// ============================================================================
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    // [VS Code 适配] 原始 iChannel1 (Keyboard) → iKeyboard
    InpState inp = gatherInp(iMouse, iKeyboard, prevDown);

    IxResult r = processInteraction(inp, iMouse, res, iFrame, iChannel0, iKeyboard);

    fragColor = applyIxResult(px, r, inp, iChannel0, iKeyboard, res, iFrame);
}
